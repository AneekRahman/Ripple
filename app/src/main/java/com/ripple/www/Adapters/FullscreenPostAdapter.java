...
public class FullscreenPostAdapter extends RecyclerView.Adapter<FullscreenPostAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView mPostDpImageView, mBufferingSpinner, mHeartImageView, mCommentImageView, mBroadcastImageView, mCollapseIcon;
        private LinearLayout mPostInteractionHolder, mPostUserIdentityHolder;
        ...
        private MyViewHolder(View view) {
            ...
            mPostUserIdentityHolder = (LinearLayout) view.findViewById(R.id.regular_post_user_identity_holder);
            ...
            mCollapseIcon = (ImageView) view.findViewById(R.id.fullscreen_collapse_icon);
        ...
        private void setUpPostClickListeners(){
            ...
            mPostExoPlayerView.setControllerVisibilityListener(new PlayerControlView.VisibilityListener() {
                ...
                public void onVisibilityChange(int visibility) {
                    ...
                    if(visibility == View.VISIBLE){
                        ...
                        mPostUserIdentityHolder.startAnimation(fadeIn);
                        mPostUserIdentityHolder.setVisibility(View.VISIBLE);
                        ...
                        mCollapseIcon.startAnimation(fadeIn);
                        ...
                        mPostUserIdentityHolder.startAnimation(fadeOut);
                        mPostUserIdentityHolder.setVisibility(View.GONE);
                        ...
                        mCollapseIcon.startAnimation(fadeOut);
            ...
            mCollapseIcon.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
    ...
    public FullscreenPostAdapter(List<RegularPost> postsList, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.full_screen_post_layout, parent, false);
